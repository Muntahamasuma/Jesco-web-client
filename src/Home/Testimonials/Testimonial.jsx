...
const Testimonial = () => {
  return (
    <div>
      <h2 className="text-[#FD6B64] text-center font-bold text-4xl">
        #testimonials
      </h2>
      <div className="border-t border-gray-300 mt-6"></div>

      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 items-center justify-center w-full dark:text-gray-900">
          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
            ...
            <div className="flex flex-col items-center justify-center p-8 rounded-b-lg dark:bg-violet-600 dark:text-gray-50">
              <img
                src="https://i.ibb.co.com/1ZM8n44/1-1.png"
                alt=""
          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
            ...
            <div className="flex flex-col items-center justify-center p-8 rounded-b-lg dark:bg-violet-600 dark:text-gray-50">
              <img
                src="https://i.ibb.co.com/dPYhmq7/3-1.png"
                alt=""
                className="w-16 h-16 mb-2 -mt-16 bg-center bg-cover rounded-full dark:bg-gray-500 dark:bg-gray-300"
              />
              <p className="text-xl font-semibold leading-tight">
          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
            ...
            <div className="flex flex-col items-center justify-center p-8 rounded-b-lg dark:bg-violet-600 dark:text-gray-50">
              <img
                src="https://i.ibb.co.com/qstJCnJ/2-1.png"
                alt=""
                className="w-16 h-16 mb-2 -mt-16 bg-center bg-cover rounded-full dark:bg-gray-500 dark:bg-gray-300"
              />
              <p className="text-xl font-semibold leading-tight">
